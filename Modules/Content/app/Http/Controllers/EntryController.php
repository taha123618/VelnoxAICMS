...
class EntryController extends Controller
{
    ...
    public function store(Request $request, Collection $collection)
    {
        ...
        return to_route('admin.collections.entries.index', $collection)->with('success', 'Entry created successfully.');
    }
    ...
    public function update(Request $request, Collection $collection, Entry $entry)
    {
        ...
        return to_route('admin.collections.entries.index', $collection)->with('success', 'Entry updated successfully.');
    }
