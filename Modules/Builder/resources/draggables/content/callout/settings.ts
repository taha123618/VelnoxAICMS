...
import GenericContentSettings from '@modules/Builder/resources/components/settings/generic-content-settings.vue';
import Component from '../../generic/generic-text.vue';
import Render from '../../generic/generic-text-render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Content', component: GenericContentSettings },
