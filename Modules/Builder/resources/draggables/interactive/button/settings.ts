...
import GenericInteractiveSettings from '@modules/Builder/resources/components/settings/generic-interactive-settings.vue';
import Component from '../../generic/generic-interactive.vue';
import Render from '../../generic/generic-interactive-render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Button Options', component: GenericInteractiveSettings },
