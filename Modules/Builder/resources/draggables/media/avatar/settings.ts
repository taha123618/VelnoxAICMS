...
import Avatar from '@modules/Builder/resources/draggables/media/avatar/avatar.vue';
import AvatarContentSettings from '@modules/Builder/resources/draggables/media/avatar/components/avatar-content-settings.vue';
import Render from '@modules/Builder/resources/draggables/media/avatar/render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Avatar', component: AvatarContentSettings },
