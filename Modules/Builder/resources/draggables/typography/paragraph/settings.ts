...
import TypographySettings from '@modules/Builder/resources/components/settings/typography-settings.vue';
import ParagraphContentSettings from '@modules/Builder/resources/draggables/typography/paragraph/components/paragraph-content-settings.vue';
import Paragraph from '@modules/Builder/resources/draggables/typography/paragraph/paragraph.vue';
import Render from '@modules/Builder/resources/draggables/typography/paragraph/render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Content', component: ParagraphContentSettings },
        { name: 'Typography', component: TypographySettings },
