...
import LinkContentSettings from '@modules/Builder/resources/draggables/typography/link/components/link-content-settings.vue';
import Link from '@modules/Builder/resources/draggables/typography/link/link.vue';
import Render from '@modules/Builder/resources/draggables/typography/link/render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Content', component: LinkContentSettings },
