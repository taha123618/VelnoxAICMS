...
import HeadingContentSettings from '@modules/Builder/resources/draggables/typography/heading/components/heading-content-settings.vue';
import Heading from '@modules/Builder/resources/draggables/typography/heading/heading.vue';
import Render from '@modules/Builder/resources/draggables/typography/heading/render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Content', component: HeadingContentSettings },
