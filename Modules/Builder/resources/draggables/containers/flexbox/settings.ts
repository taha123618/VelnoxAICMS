...
import Flexbox from '@modules/Builder/resources/draggables/containers/flexbox/flexbox.vue';
import FlexboxRender from '@modules/Builder/resources/draggables/containers/flexbox/render.vue';

export default {
    component: Flexbox,
    renderable: FlexboxRender,
    settings: [
        { name: 'Info', component: ElementInfoSettings },
        { name: 'Display', component: FlexboxSettings },
