...
import GridSettings from '@modules/Builder/resources/draggables/containers/grid/components/grid-settings.vue';
import Grid from '@modules/Builder/resources/draggables/containers/grid/grid.vue';
import Render from '@modules/Builder/resources/draggables/containers/grid/render.vue';
...
export default {
    ...
    settings: [
        ...
        { name: 'Grid settings', component: GridSettings },
